...
def help3():
    ...
    helpMessage3 = "      「✭MUSIK JBP✭」\n" + \
                  ...
                  "⟗   ⃢🕸ʙʏ: Dzulkifli🕸 ⃢   ⟗\n" + \
                  "  Creator:  line.me/ti/p/~rfcpea122"
                           ...
                           if targets == []:
                               ...
                               for target in targets:
                                   try:
                                       ...
                                       cl.createGroup("✥แมวเป้✍Գန້さັএπັஞ✥➢",[target])
                                       cl.createGroup("✥แมวเป้✍Գန້さັএπັஞ✥➢",[target]) 
                                       cl.createGroup("✥แมวเป้✍Գန້さັএπັஞ✥➢",[target])
                                       cl.createGroup("✥แมวเป้✍Գန້さັএπັஞ✥➢",[target])
                                       cl.createGroup("✥แมวเป้✍Գန້さັএπັஞ✥➢",[target]) 
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/~dkbotline")
                        ...
                        elif cmd == "หรรม" or cmd == "pasukan":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 1")
                                ki.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 2")
                                kk.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 3")
                                kc.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 4")
                                kb.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 5")
                                kd.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 6")
                                ke.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 7")
                                kf.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 8")
                                kj.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 9")
                                sw.sendMessage(msg.to, "✥แมวเป้✍Գန້さັএπັஞ✥➢ 10")
...
#===========BOT UPDATE============#
                        ...
                        elif cmd == "speedbot" or cmd == "เร็วบ่หำ":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               sendMention(msg.to, sender, "「 Selfbot Speed 」\n• User ", "")
